...
struct Home: View {
    ...
    @State var pizzaBottm : SCNScene? = .init(named: "Pizza_Box.scn")
    ...
    @State var disabledControls : Bool = false
    var body: some View {
        VStack{
            ...
            GeometryReader{proxy in
                ...
                ZStack{
                    ...
                    ZStack{
                        ...
                        CustomSeneKit(scene: $pizzaTop)
                            .frame(width:size.width, height: size.height)
                            .rotationEffect(.init(degrees: 180))
                            .scaleEffect(showBox ? 1.2 : 0.9)
                            .opacity(showBox ? 1 : 0)
                        ...
                        .offset(y: showBox ? 135 : 0)
                        
                        
                        CustomSeneKit(scene: $pizzaBottm,isTopPotition: true)
                            .frame(width:size.width, height: size.height)
                            .rotationEffect(.init(degrees: 180))
                            .scaleEffect(showBox ? 1.2 : 0.9)
                            .opacity(showBox ? 1 : 0)
                    ...
                    .offset(x:addItemCart ? -30 : 0,y:addItemCart ? -35 : 0)
    ...
    func addToCart(){
        ...
        withAnimation(.interactiveSpring(response: 0.6, dampingFraction: 0.6, blendDuration: 0.5).delay(0.4)){
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 0.5){
            ...
            pizzaBottm?.rootNode.childNode(withName: "Cover", recursively: true)?.eulerAngles.x = 0
            
            pizzaTop?.rootNode.childNode(withName: "Closed_Box", recursively: true)?.eulerAngles.x = 0
    ...
    func claearAniamtion(){
        ...
        pizzaBottm = .init(named: "Pizza_Box.scn")
